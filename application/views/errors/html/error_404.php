...
<head>
<meta charset="utf-8">
<title><?=SITE_NAME?> | 404 Página não encontrada</title>
...
<body>
	<div id="container">
		...
		<div class="text-center">
            <img alt="404 Logo" src="<?=BASE_URL?>_template/img/error.svg" style="max-height: 100px;" class="mb-3">
            <h3 class="text-gray-800 font-weight-bold">Oopss!</h3>
            <p class="lead text-gray-800 mx-auto">404 Página não encontrada</p>
            <a href="<?=BASE_URL?>">← Voltar para login</a>
        </div>
	</div>
</body>
</html>
